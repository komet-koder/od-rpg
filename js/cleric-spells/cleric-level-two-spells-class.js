...
let blessCleric = new ClericLevelTwoSpells (
    "Bless", 
    2, 
    60, 
    6, 
    "Improves morale of friendly creatures by +1, give +1 hit and damage rolls", 
...
let findTrapsCleric = new ClericLevelTwoSpells (
    ...
    0, 
    2, 
    "Causes traps to glow with blue light with 30 feet", 
    function() {console.log('Casting');}, 
    "find-traps-cleric",
    false,
    0,
...
let holdPersonCleric = new ClericLevelTwoSpells (
    ...
    180, 
    9, 
    "Affects humans, humanoids, but not undead or creatures larger than Ogres", 
    function() {console.log('Casting');}, 
    "hold-person-cleric",
    true,
    0,
...
let knowAlignmentCleric = new ClericLevelTwoSpells (
    ...
    0, 
    1, 
    "Caster discovers alignment of creatures or items withing 10 feet", 
    function() {console.log('Casting');}, 
...
let resistFireCleric = new ClericLevelTwoSpells (
    ...
    30, 
    2, 
    "Cannot be harmed by fire, +2 Saving Throw against all magical fire", 
    function() {console.log('Casting');}, 
    "resist-fire-cleric",
    true,
    0,
...
let snakeCharmCleric = new ClericLevelTwoSpells (
    ...
    60, 
    5, 
    "Charm 1 HD of snakes for each level of the cleric", 
    function() {console.log('Casting');}, 
    "snake-charm-cleric",
    true,
    0,
